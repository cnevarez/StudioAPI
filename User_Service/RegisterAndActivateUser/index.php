...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <form method="post"  action="../../../scripts/RegisterAndActivateUSer.php?guid=<?php echo $guid?>&pass=<?php echo $pass?>&email=<?php echo $email?>&mfpass=<?php echo $mfpass?>&accid=<?php echo $accid?>">
        ...
        <div class="form-group">
          ...
          <label>Email</label>
          <span style="color:red;"> &#42</span>
          <input class="form-control " type="text" name="userEmail" placeholder="John@Sample.com" required>
          </div>
