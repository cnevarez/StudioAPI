...
<div id="container">
  ...
  <div id="listingcontainer">
	...
	?>
      <div><a href="<?=$fileurl;?><?="?guid=".$guid."&pass=".$pass."&email=".$email."&mfpass=".$mfpass."&accid=".$accid?>" class="<?=$class;?>"<?=$thumb2;?>><img src="http://www.000webhost.com/images/index/<?=$icon;?>" alt="<?=$files[$i];?>" /><strong>
        <?=$filename;?>
        </strong> <em>
